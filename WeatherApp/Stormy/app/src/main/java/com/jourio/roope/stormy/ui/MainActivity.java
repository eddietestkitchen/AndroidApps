...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final double latitude = 60.1920;
        final double longitude = 24.9458;
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "92404b5cbe52d93eb96035b97f166d07";
    ...
    private Current getCurrentDetails(String jsonData) throws JSONException {
        JSONObject forecast = new JSONObject(jsonData);
        String timezone = forecast.getString("timezone"); // Getting the data from JSON format
    ...
    public void startHourlyActivitiy(View view) {
